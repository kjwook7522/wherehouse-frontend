    ...
    axios
      ...
      .then(res => {
        ...
        //  console.log(containerDetail);
          for(let i=0;i<7;i++){
            if(containerDetail.types[i]==="ROOM_TEMPERATURE")
              typeFlag1="true"
              if(containerDetail.types[i]==="LOW_TEMPERATURE")
              typeFlag2="true"
              if(containerDetail.types[i]==="BONDED")
              typeFlag3="true"
              if(containerDetail.types[i]==="SAVAGE")
              typeFlag4="true"
              if(containerDetail.types[i]==="HAZARDOUS")
              typeFlag5="true"
              if(containerDetail.types[i]==="SELF_STORAGE")
              typeFlag6="true"
              if(containerDetail.types[i]==="CONTAINER")
              typeFlag7="true"
          }
